...
const SCRIPT_URL = "https://script.google.com/macros/s/AKfycbw1OXOzP77UTIfgu3vd_gw4aoSkgahtrCC3tAc3XuFgn_hwgjwVJNSZBCFl63QKAC-e/exec";
...
function updateContactDisplay(contactInfo) {
    ...
    if (customerSupportElement) {
        ...
        customerSupportElement.textContent = customerSupport || 'Contact information not available';
    ...
    if (mainOfficeElement) {
        ...
        mainOfficeElement.textContent = mainOffice || 'Office information not available';
...
function showContactLoadError() {
    ...
    if (loadingElement) {
        loadingElement.innerHTML = '<i class="fas fa-exclamation-triangle"></i> Unable to load contact information. Please try refreshing the page.';
    ...
    if (detailsElement) {
        ...
        if (customerSupportElement) {
            customerSupportElement.textContent = 'Unable to load customer support information';
        }
